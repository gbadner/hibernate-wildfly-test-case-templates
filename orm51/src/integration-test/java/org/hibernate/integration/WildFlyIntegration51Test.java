...
public class WildFlyIntegration51Test {
	...
	private static PersistenceDescriptor persistenceXml() {
		return Descriptors.create( PersistenceDescriptor.class )
				...
				.up()
				.createProperty()
				.name( AvailableSettings.CACHE_REGION_PREFIX )
				.value( "TEST" )
				.up()
				.up()
				.up();
	...
	private SecondLevelCacheStatistics statistics;
	...
	public void setupData() throws Throwable {
		...
		statistics = entityManager.getEntityManagerFactory().unwrap( SessionFactory.class ).getStatistics()
				.getSecondLevelCacheStatistics( "TEST." + Employee.class.getName() );
	...
	public void testOldValueInOtherThreadNewValueInCurrentAfterUpdate() throws Throwable {
		...
		completeInTransaction.accept(() -> {
			...
			// The following assertions show what happens using WildFly 10.1
